...
;(function($, window, undefined) {
  ...
  Plugin.prototype = {
    init: function() {
      ...
      that.element.unbind('click.check').bind('click.check', function () {
        var me = $(this);
        if(me.hasClass('checked')){
          me.removeClass('checked');
          me.children('input[type="checkbox"]').attr('checked', false).removeClass('checked');
        }else{
          me.addClass('checked');
          me.children('input[type="checkbox"]').attr('checked', true).addClass('checked');
        }
      });
    ...
    destroy: function() {
      var that = this;
      that.element.unbind('click.check');
    }
  };
